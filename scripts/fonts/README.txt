Fonts bundled for scripts/make-social-images.py only. They are NOT served to
visitors — the website loads Archivo and Figtree from Google Fonts at runtime.
